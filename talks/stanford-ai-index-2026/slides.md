...
<div class="question-grid">
  ...
  <div class="question-card question-card-accent">
...
<div class="keyword-column">
  ...
  <div class="keyword-block keyword-block-dark">
...
<div class="editorial-split">
  ...
  <div class="comparison-board">
    ...
    <div class="comparison-caption">AI 已经不是科技爱好者的玩具，而是以主流社会的速度快速进入日常。</div>
  </div>
</div>
...
<div class="mood-split">
  ...
  <div class="mood-body">
    <ul class="clean-list">
      <li>喜欢的是：搜索、翻译、写作、总结、编程辅助</li>
      <li>担心的是：工作替代、深度伪造、隐私泄露、系统失控</li>
      <li>它不是一个统一结论，而是一种复杂的社会情绪</li>
    </ul>
  </div>
</div>
...
<div class="tri-upgrade">
  ...
  <div class="tri-upgrade-card tri-upgrade-card-accent">
...
<div class="shift-footer">
  <div class="shift-footer-stat">
    <div class="shift-footer-number">93%</div>
    <div class="shift-footer-copy">处理网络安全问题的 AI agent 成功率</div>
  </div>
  <div class="shift-footer-note">过去更多是"我问 AI 一个问题"，现在越来越像"我把一段任务交给 AI"。</div>
</div>
...
<div class="cascade-layout">
  <div class="cascade-stats">
    ...
    <div class="cascade-arrow-area">
      <div class="cascade-arrow-down"></div>
    </div>
    <div class="cascade-row cascade-row-highlight">
  ...
  <div class="paper-card">
    ...
    <div class="chart-caption mt-5">未来更重要的，可能不是会不会做题，而是会不会提问、会不会验证、会不会独立思考。</div>
  </div>
</div>
...
<div class="editorial-split">
  ...
  <div class="comparison-board">
    ...
    <div class="comparison-caption">AI 正在从科研工具，逐渐变成科研参与者。</div>
  </div>
</div>
...
<div class="weather-layout">
  <div class="weather-flow">
    ...
    <div class="weather-connector"></div>
    <div class="weather-step weather-step-accent">
...
<div class="two-panel">
  <div class="hero-stat hero-stat-dark">
...
<div class="statement-shell">
  ...
  <div class="statement-support">AI 的代价，开始越来越像水、电、路。</div>
</div>
